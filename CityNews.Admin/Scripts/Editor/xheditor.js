...
var bMobile=agent.indexOf('mobile')!==-1,browser=null,browerVer=11.0,isIE=false,isMozilla=false,isSafari=false,isOpera=false;
...
var xheditor=function(textarea,options)
{
	...
	this.toggleFullscreen=function(state)
	{
		...
		var jLayout=$('#'+idContainer).find('.xheLayout'),jContainer=$('#'+idContainer),browserVer=11.0,isIE67=(isIE&&(browserVer==6||browserVer==7));
		if(bFullscreen)
		{//取消全屏
